...
1. REST API Development using Flask  
2. Database Design & SQL using PostgreSQL (Supabase)  
3. Data Analysis & Visualization using Python  
...
1. Top 3 customers with highest orders  
